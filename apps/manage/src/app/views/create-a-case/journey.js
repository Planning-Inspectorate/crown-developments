...
/**
 * @param {{[questionType: string]: import('@pins/dynamic-forms/src/questions/question').Question}} questions
	...
	return new Journey({
		...
		sections: [
			new Section('Section 1', 'questions')
				...
				// TODO: lpa
				.addQuestion(questions.lpaContactName)
				.addQuestion(questions.lpaContactAddress)
				.addQuestion(questions.lpaContactEmail)
				.addQuestion(questions.lpaContactTelephoneNumber)
				...
				.withCondition((response) => questionHasAnswer(response, questions.hasAgent, BOOLEAN_OPTIONS.YES))
				.addQuestion(questions.sitePostCode)
				.addQuestion(questions.siteNorthing)
				.addQuestion(questions.siteEasting)
				.addQuestion(questions.siteArea)
				.addQuestion(questions.projectName)
				.addQuestion(questions.projectDescription)
