...
/**
 * A category with a parent category connection
 */
type CategoryWithParent = Prisma.CategoryCreateInput & {
...
export function subCategoriesToRadioOptions(categories: readonly Prisma.CategoryCreateInput[]): SelectableOption[] {
	...
	const subCategories = categories
		.filter((c): c is CategoryWithParent => 'ParentCategory' in c && c.ParentCategory !== undefined)
		.map((c) => {
