 ...
 * @param {import('@pins/dynamic-forms/src/controller.js').MoveAttachmentsToCaseFolderFn} [moveAttachmentsToCaseFolderFn] Optional function to move attachments to case folder for testing
 * @param {import('@pins/dynamic-forms/src/controller.js').DeleteRepresentationAttachmentsFolderFn} [deleteRepresentationAttachmentsFolderFn] Optional function to delete representation attachments folder for testing
