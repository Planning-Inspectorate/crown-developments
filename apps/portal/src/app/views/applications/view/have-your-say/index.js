...
export function createHaveYourSayRoutes({ db, logger, config }) {
	...
	router.get('/', isRepresentationWindowOpen, asyncHandler(viewHaveYourSayPage));

	router.get('/:section/:question', isRepresentationWindowOpen, getJourneyResponse, getJourney, question);
	...
	router.get('/check-your-answers', isRepresentationWindowOpen, getJourneyResponse, getJourney, (req, res) =>
		list(req, res, '', {})
	);
