...
describe('have-your-say journey', () => {
	...
	it('should change question text based on isFrontend', () => {
		let questions = getQuestions({ isFrontend: true });
		assert.strictEqual(questions.submittedFor.question, 'Who are you submitting a representation for?');

		questions = getQuestions({ isFrontend: false });
