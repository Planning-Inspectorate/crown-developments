...
describe('view-model', () => {
	...
	describe('applicationLinks', () => {
		...
		it('should include Have your say when within the representation submission period', () => {
			const id = 'id-1';
			mock.timers.setTime(Date.parse('2025-01-01T03:24:00'));
		...
		it('should not include Have your say when outside the representation submission period', () => {
			const id = 'id-1';
			mock.timers.setTime(Date.parse('2025-01-31T00:00:00'));
			const haveYourSayPeriod = {
				start: new Date('2025-01-01T00:00:00.000Z'),
				end: new Date('2025-01-30T23:59:59.000Z')
			};
