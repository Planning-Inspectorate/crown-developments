...
// Note - Still using placeholder CrownDev database
...
//New defined type for Prisma output - NOTE CrownDev Placeholder fields
...
//New defined mapping function for S62ADevelopmentListItem type - NOTE CrownDev Placeholder fields
export function s62aDevelopmentListItemToViewModel(crownDevelopment: S62ADevelopmentListItem): S62ADevelopmentView {
	return {
		id: crownDevelopment.id,
		reference: crownDevelopment.reference,
		applicationType: crownDevelopment.Type?.displayName ?? undefined,
		applicantName: crownDevelopment.ApplicantContact?.orgName ?? undefined,
		lpaName: crownDevelopment.Lpa?.name ?? undefined,
		stage: crownDevelopment.Stage?.displayName ?? undefined,
...
>;
export type S62ADevelopmentView = {
	id: string;
	reference: string;
