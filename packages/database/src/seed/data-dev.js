...
const representations = [
	...
	},
	{
		...
		comment: 'Some comment about this application',
		submittedDate: new Date('2025-02-03T10:32:00.000Z'),
		SubmittedFor: { connect: { id: REPRESENTATION_SUBMITTED_FOR_ID.ORGANISATION } },
		SubmittedByContact: { connect: { id: repsContacts[5].id } },
		OrganisationContact: { connect: { id: repsOrgContacts[0].id } },
		organisationRole: 'Chief Commenter',
		Status: { connect: { id: REPRESENTATION_STATUS_ID.ACCEPTED } }
	},
	{
		...
		OrganisationContact: { connect: { id: repsOrgContacts[1].id } },
	...
	},
	{
		...
		OrganisationContact: { connect: { id: repsOrgContacts[2].id } },
		organisationRole: 'Planning Person',
		Status: { connect: { id: REPRESENTATION_STATUS_ID.AWAITING_REVIEW } }
	},
	{
		...
		OrganisationContact: { connect: { id: repsOrgContacts[3].id } },
	...
	},
	{
		...
		OrganisationContact: { connect: { id: repsOrgContacts[4].id } },
		organisationRole: 'Community Spokesperson',
		Status: { connect: { id: REPRESENTATION_STATUS_ID.AWAITING_REVIEW } }
	},
	{
