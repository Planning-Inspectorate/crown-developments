import type { Prisma } from '@pins/crowndev-database/src/client/client.d.ts';
import { PrismaClient } from '@pins/crowndev-database/src/client/client.ts';
import type { DatabaseConfig } from '@pins/crowndev-lib/app/config-types.js';
