...
export const getQuestions = ({
	...
	const questionProps = {
		...
		submittedFor: {
			...
			question: isPortalQuestion ? 'Who are you submitting a representation for?' : 'Source of representation',
		...
		whoRepresenting: {
			...
			question: isPortalQuestion ? 'Who are you representing?' : 'Representation made on behalf of',
		...
		orgRoleName: {
			...
			question: isPortalQuestion ? 'What is your job title or volunteer role?' : "Sender's job title or role",
