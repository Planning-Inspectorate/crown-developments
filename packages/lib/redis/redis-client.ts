...
export class RedisClient {
	...
	readonly set: (key: string, value: string) => Promise<string | null>;
...
/**
 * @param str - in the form 'some.example.org:6380,password=some_password,ssl=True,abortConnect=False'
 */
