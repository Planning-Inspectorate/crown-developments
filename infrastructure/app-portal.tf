module "app_portal" {
  ...
  source = "github.com/Planning-Inspectorate/infrastructure-modules.git//modules/node-app-service?ref=abf2c32917acf31125beafcc8457dae0953a5768"
  ...
  tags = module.security_tags["portal"].tags
